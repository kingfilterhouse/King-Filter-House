...
(function() {
    ...
    function loadSettings() {
        const pin      = localStorage.getItem('kfh_finance_pin') || '1708';
        const bizName  = localStorage.getItem('kfh_biz_name')   || 'King Filter House';
        const currency = localStorage.getItem('kfh_currency')    || 'PKR';
    ...
    window.saveNewPin = function() {
        ...
        localStorage.setItem('kfh_finance_pin', newPin);
        // Update live PIN in finance module
    ...
    window.saveBusinessSettings = function() {
        ...
        if (biz) localStorage.setItem('kfh_biz_name', biz);
        if (cur) localStorage.setItem('kfh_currency', cur);
        msg.style.color = 'var(--color-success)';
        msg.textContent = '✅ Saved (takes effect on next page load)';
    };
})();
...
(function() {
    let CORRECT_PIN = localStorage.getItem('kfh_finance_pin') || '1708';
    // Allow settings to update it live
