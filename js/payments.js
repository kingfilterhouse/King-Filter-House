...
async function loadPayments(transactionId, transactionType) {
    try {
        console.log('🔄 Loading payments for:', transactionType, transactionId);
...
window.openPaymentManagement = async function(transactionId, transactionType, transactionData) {
    try {
        console.log('💳 Opening payment management for:', transactionType, transactionId);
...
async function updateTransactionPaymentStatus() {
    try {
        ...
        console.log('✅ Transaction payment status updated:', paymentStatus, '| Remaining:', remaining);
    } catch (error) {
