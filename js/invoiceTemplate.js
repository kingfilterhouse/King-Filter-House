...
let settings = {
    ...
    customBg: null,
    layout: {},
    businessName:    'King Filter House',
...
function loadSettings() {
    try {
        ...
        if (s) {
            ...
            // Don't load customBg from localStorage if it's huge — check size
...
function getBiz() {
    return {
        name:    settings.businessName    || 'King Filter House',
...
window.InvoiceTemplate._saveBiz = function () {
    settings.businessName    = document.getElementById('itm-bname')?.value.trim()    || 'King Filter House';
...
console.log('✅ Invoice Template Module Loaded');
